...
First consult `.claude/references/architecture.md` for the key-file index and data flow so you start from known files (routes, `APP_ENVIRONMENT`, Signal K client, `state/` stores, `features/chart/`).
